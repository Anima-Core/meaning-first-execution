...
> **When MFEE invokes the transformer, output is exactly identical to the baseline transformer output under deterministic decoding. All savings arise exclusively from avoided invocations.**
...
**For evaluation framework issues:** [GitHub Issues]  
**For sealed engine access:** [Contact Information]  
**For enterprise deployment:** [Enterprise Support]
